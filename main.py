...
class AudioRecorderApp:
    ...
    def record_audio(self, filename):
        ...
        self.audio_db1.insert_record(filename, os.path.abspath(save_path))
...
class AudioDatabase:
    def __init__(self, db_name="audio_record.db"):
...
if __name__ == "__main__":
    ...
    audio_files = app.audio_db1.get_audio_files()
    st.write(app.audio_db1.get_audio_files())
    if audio_files:
